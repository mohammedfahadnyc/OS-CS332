/*
CSc332 OS Lab
Instructor: Mohammed Fahad
Author: Sujoy Debnath
Task 1, part 4: (a) Read the next 100 characters from source.txt, and among
    characters read, replace each character ’1’ with character ’L’
